...
cd "${path}"
cap log close 
log using "Output/session_${kernel}${BRFSS_2020}", replace
...
* Save
graph export "Output/Estimates_30_day_${kernel}_${BRFSS_2020}.pdf", replace		
...
* Save
graph export "Output/Estimates_30_day_${kernel}_${BRFSS_2020}_bigfont.pdf", replace	
...
* Loop Estimates for binary variables
local i=1
local j=1
...
* Save
graph export "Output/Estimates_discrete_${kernel}_${BRFSS_2020}.pdf", replace		
...
* Save log file
translate "Output/session_${kernel}.smcl" "Output/session_${kernel}_${BRFSS_2020}.pdf", replace
log close 